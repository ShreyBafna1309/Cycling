...
function draw() {
  ...
  var obstacles_place = Math.round(random(1,3));

  if(World.frameCount % 150 == 0){
    if(obstacles_place == 1){
      obstacle_1();
    }
    if(obstacles_place == 2){
      obstacle_2();
    }
    if(obstacles_place == 3){
      obstacle_3();
    }
  }
...
function obstacle_1(){
  obstacle1 = createSprite(1000,Math.round(random(50,250)));
...
function obstacle_2(){
  obstacle2 = createSprite(1000,Math.round(random(50,250)));
...
function obstacle_3(){
  obstacle3 = createSprite(1000,Math.round(random(50,250)));
